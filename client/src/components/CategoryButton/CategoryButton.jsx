...
const CategoryButton = ({ categories, setFiltered, projects }) => {
  ...
  return (
    <ul className="grid grid-cols-4 md:flex md:flex-row gap-3 md:gap-x-6 mb-5">
      <li
        className={`py-2 md:py-3 px-3 md:px-7 rounded-md cursor-pointer text-center hover:text-[#252531] ${
          "tümü" === categoryTitle && "text-[#252531] border border-[#252531]"
        }`}
      ...
      {categories.map((category, index) => (
        <li
          className={`py-2 md:py-3 px-3 md:px-7 rounded-md cursor-pointer text-center hover:text-[#252531] ${
            ...
            "text-[#252531] border border-[#252531]"
          }`}
